...
<body>
    ...
    <section class="inner-banner" style="background: url(./images/dementia-care.jpg);">
        <div class="container">
            <div class="breadcrumbs">
                <ul>
                    <li><a href="">home</a></li>
                    <li><a href="">care service</a></li>
                    <li><a href="">Dementia & Alzheimer’s Care</a></li>
                </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="care-top-text">
                        <p>
                            The more care & support is required for  people with dementia as their symptoms get worse over time. To meet their care needs arogin care home can be a better place
                        </p>

                        <h5>Dementia Care include:</h5>

                        <ul>
                            <li>Round the clock support from nursing staff & care givers.</li>
                            <li>Doctor visit on a regular basis</li>
                            <li>Engagement & recreational activities</li>
                            <li>knowing that the person with dementia is in a safe place</li>
