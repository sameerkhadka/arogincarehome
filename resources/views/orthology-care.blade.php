...
<body>
    ...
    <section class="inner-banner" style="background: url(./images/arogin.jpg);">
        <div class="container">
            <div class="breadcrumbs">
                <ul>
                    <li><a href="">home</a></li>
                    <li><a href="">care service</a></li>
                    <li><a href="">Ortho & Spinal Injury Care</a></li>
                </ul>
                <h3>Ortho & Spinal Injury Care</h3>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="care-top-text">
                        <p>At Arogin care Home  we provide our patients with remarkable orthopedic and spinal rehabilitation services . From features 24/7 Nursing care services, Intensive Physiotherapy and rehabilitation services , nutritious food and balanced diet,  Arogin provides it all . As a result, the patients are offered with services from reputed doctors and skilled staff nurses for their recovery and well being. </p>
                    </div>
                </div>
            </div>
        </div>
