...
<body>
    ...
    <section class="inner-banner" style="background: url(./images/pharmacy.jpg);">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="care-top-text">
                        <p>
                            Pharmacists are critical in assisting patients in feeling better and recovering as quickly as possible. Because pharmacists are medication specialists, patients benefit from having pharmacists on their healthcare teams. At Arogin, Pharmacists help patients stick to their prescription regimens. They are culturally competent healthcare workers that successfully communicate to assess a variety of elements that influence a patient's capacity to comply 
                        </p>
                    </div>
                </div>
            </div>
