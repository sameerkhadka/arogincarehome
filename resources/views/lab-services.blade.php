...
<body>
    ...
    <section class="inner-banner" style="background: url(./images/lab-services.jpg);">
        <div class="container">
                ...
                <div class="col-md-8">
                    <div class="care-top-text">
                        <p>
                            ...
                            Here at Arogin’s Laboratory Services, we collect blood and bodily fluids for tests requested by your doctor or healthcare provider, as well as a wide range of regular and specialized lab testing as well as clinical consultations:

                        </p>

                        <ul>
                            <li>Blood Testing </li>
                            <li>Genetics and Genomy</li>
